...
{%- block body -%}
  ...
  <div class="option" id="pools" onclick="window.location='{{ base_url }}/grader/pools'">
  ...
  <div class="option" id="templates" onclick="window.location='{{ base_url }}/grader/templates'">
